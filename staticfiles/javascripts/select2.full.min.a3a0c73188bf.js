            ...
            !(function (b) {
              ...
              function f(a, b) {
                ...
                if (a && "." === a.charAt(0))
                  if (b) {
                    for (
                      n = n.slice(0, n.length - 1), a = a.split("/"), g = a.length - 1, s.nodeIdCompat && w.test(a[g]) && (a[g] = a[g].replace(w, "")), a = n.concat(a), k = 0;
                      k < a.length;
                      k += 1
                    )
                ...
                a.fn.mousewheel &&
                  this.$results.on("mousewheel", function (a) {
                    ...
                    e
                      ...
                      : f && (c.$results.scrollTop(c.$results.get(0).scrollHeight - c.$results.height()), a.preventDefault(), a.stopPropagation());
                  }),
            ...
            (a.prototype.query = function (a, b, c) {
              return (
                ...
                b.term.length < this.minimumInputLength
                  ? void this.trigger("results:message", { message: "inputTooShort", args: { minimum: this.minimumInputLength, input: b.term, params: b } })
            ...
            (e.prototype.destroy = function () {
              this.$container.remove(),
                ...
                null != this._observer
                  ...
                  : this.$element[0].removeEventListener && this.$element[0].removeEventListener("DOMAttrModified", this._sync, !1),
                (this._sync = null),
