...
urlpatterns = [
    ...
    path('travel-insurance', views.travel_insurance, name="travel-insurance"),
     path('travel-insurance-old', views.travel_insuranceOld, name="travel-insurance-old"),
    path('visa-assistance', views.visa_assistance, name="visa-assistance"),
     path('visa-assistance-old', views.visa_assistance_old, name="visa-assistance-old"),
          path('post-arrival-services', views.postArrivalServices, name="post-arrival-services"),
